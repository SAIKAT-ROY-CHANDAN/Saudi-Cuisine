    ...
    <section id="#contact" className="bg-contact-banner h-lvh mb-20 bg-cover bg-center">
      <div className="max-w-7xl mx-auto space-y-6 flex flex-col h-full justify-center">
        ...
        <div className="max-w-lg space-y-6">
          ...
          <div
            className="relative mb-3 max-w-lg border border-gray-300"
            data-twe-input-wrapper-init
          >
            <textarea
              className="peer block min-h-48 w-full rounded border-0 bg-transparent px-3 py-[0.32rem] leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 peer-focus:text-primary data-[twe-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-white dark:placeholder:text-neutral-300 dark:peer-focus:text-primary [&:not([data-twe-input-placeholder-active])]:placeholder:opacity-0"
